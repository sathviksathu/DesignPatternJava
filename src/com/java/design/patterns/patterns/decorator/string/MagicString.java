package com.java.design.patterns.patterns.decorator.string;
...
/**
 * As you can see here, since String is a final class in java
 * you cannot subclass it, hence decorator pattern steps in right in these kind of scenarios
 * and also many other scenarious, but this one of them.
 *
 * So what you are doing is basically wrapping it in a "MagicString" object, it's like you are decorating
 * java String class with something, and whoever uses client need not know what's happening inside, for them
 * it's just string with a few added functionality.
 */
public class MagicString {
    ...
    //This is like adding getNumberofVowels functionality to plain old java string class
    //You have basically decorated the string java class.
